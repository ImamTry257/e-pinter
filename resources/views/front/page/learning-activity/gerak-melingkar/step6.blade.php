            ...
            <div class="wrapper-step-1 pb-4">
                ...
                <div class="desc-step mt-3">
                    <p class="text-justify p-3">Silahkan presentasikan hasil proyek dan laporanmu secara bergantian.
                        Jadi, kesimpulannya apakah anda dapat memvisulisasikan gambar 1 tersebut? dan Apakah teknologi yang digunakan bisa digunakan untuk memvisualisasi gerak melingkar?</p>
                </div>
...
@include('front.page.learning-activity.gerak-melingkar.script.js-gm')
@endsection
