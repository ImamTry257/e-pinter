...
<div>
    ...
    <div class="row pt-5 wrapper-content pb-5 d-flex justify-content-center">
        <div class="col-md-10">
            <div>
                <ul class="nav nav-tabs">
                    <li class="nav-item custome-link">
                      <a class="nav-link active" id="1" aria-current="page" href="#">Kegiatan 1</a>
                    </li>
                    <li class="nav-item custome-link">
                        <a class="nav-link" id="2" aria-current="page" href="#">Kegiatan 2</a>
                    </li>
                    <li class="nav-item custome-link">
                        <a class="nav-link" id="3" aria-current="page" href="#">Kegiatan 3</a>
                    </li>
                </ul>
            </div>

            {{--  Acitvity 1 --}}
            <div class="pt-3" id="step-1">
                {{-- STEP 1 --}}
                ...
                <div class="wrapper-step-2 pb-4">
                    ...
                    <div class="question-step-2">
                        ...
                        <div class="question-b pt-4">
                            ...
                            <div>
                                <textarea name="question-b" id="input-form-a-1" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper-step-3 pb-4">
                    ...
                    <div class="question-step-3">
                        ...
                        <div class="question-b pt-4">
                            ...
                            <div>
                                <textarea name="question-b" id="input-form-b-1" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{--  Acitvity 2 --}}
            <div class="pt-3 d-none" id="step-2">
                {{-- STEP 1 --}}
                <div class="wrapper-step-1 pb-4">
                    <h5 class="pb-2">Langkah 1: Orientasi dan Identifikasi pada Masalah</h5>
                    <h6>Mari Baca artikel dan amati gambar di bawah ini</h6>
                ...
                <div class="wrapper-step-2 pb-4">
                    ...
                    <div class="question-step-2">
                        <div class="question-a">
                            ...
                            <div>
                                <textarea name="" id="input-form-a-2" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="question-b pt-4">
                            ...
                            <div>
                                <textarea name="question-b" id="input-form-b-2" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper-step-3 pb-4">
                    ...
                    <div class="question-step-3">
                        ...
                        <div class="question-b pt-4">
                            ...
                            <div>
                                <textarea name="question-b" id="input-form-b-3" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{--  Acitvity 3 --}}
            <div class="pt-3 d-none" id="step-3">
                {{-- STEP 1 --}}
                <div class="wrapper-step-1 pb-4">
                    <h5 class="pb-2">Langkah 1: Orientasi dan Identifikasi pada Masalah</h5>
                    <h6>Mari Baca artikel dan amati gambar di bawah ini</h6>
                ...
                <div class="wrapper-step-2 pb-4">
                    ...
                    <div class="question-step-2">
                        <div class="question-a">
                            ...
                            <div>
                                <textarea name="" id="input-form-a-3" cols="30" rows="10"></textarea>
                            </div>
                        </div>
