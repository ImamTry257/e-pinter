    ...
    <div class="card list-topic-content py-5 px-2 col-12">
        <div class="row p-2 px-5">
            <div class="wrapper-step-1 pb-4">
                ...
                <div>
                    <img src="{{ asset('assets/pemb3-question-img.svg') }}" alt="" class="w-25">
                </div>
                <div class="desc-step mt-3">
                    <p class="text-justify p-3">Ilustrasi pada gambar tersebut merupakan bianglala di pasar malam. Gerakan bianglala tersebut lintasannya berbentuk lingkaran.  Bagaimana kita bisa mengetahui visualisasimateri fisika yang ada di gambar tersebut ya?</p>
                </div>
            ...
            <div class="col-lg-12 text-start">
                ...
                <a href="{{ route('front.activity.step', ['slug' => $slug, 'step' => 2]) }}" id="btn-step-1" class="btn btn-information text-white">Selanjutnya Sintak 2.</a>
            </div>
        </div>
    </div>
</div>
