    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-popup">
                <h5 class="modal-title text-white" id="staticBackdropLabel">Info Soal</h5>
            </div>
            <div class="modal-body">
                <div class="text-center">
                    <span class="pb-3" style="font-size: 18px;">Silakan pilih Sesi berikut untuk mengerjakan soal</span>
                </div>

                <div class="d-flex justify-content-evenly mt-3">
                    <a href="{{ route('question.type', ['type' => 'pre-test', 'questionNo' => Crypt::EncryptString(1)]) . '-' . $current_duration }}" class="btn bg-popup text-white">Pre Test</a>
                    <a href="{{ route('question.type', ['type' => 'post-test', 'questionNo' => Crypt::EncryptString(1)]) . '-' . $current_duration }}" class="btn bg-popup text-white">Post Test</a>
                </div>
            </div>
        </div>
    </div>
