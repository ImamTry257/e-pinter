            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card border-0">
                        ...
                        @endphp
                        <div class="card-body">
                            <form action="{{ route('admin.questionniare.manage.update', ['id' => $id]) }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="page" value="{{ $questionniare->page }}" id="">
                                                @error('page')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="number" value="{{ $questionniare->number }}" id="">
                                                @error('number')
                                                    <span class="invalid-feedback d-inline" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
