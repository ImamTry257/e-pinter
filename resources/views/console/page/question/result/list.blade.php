    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 pb-2">
                    <a href="{{ route('admin.question.result.download.type', ['type' => $type_selected]) }}" class="btn bg-console text-dark"><i class="fas fa-download"></i> Download Hasil</a>
                </div>
                <div class="col-md-12">
    ...
    <script type="text/javascript">
        $(function () {
          ...
          var table = $('.la-datatable').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ route('admin.question.result.get.user.type', ['type' => $type_selected]) }}",
              columns: [
