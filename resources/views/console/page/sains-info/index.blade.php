    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 pb-2">
                    <a href="{{ route('admin.sains-info.add') }}" class="btn bg-console text-dark"><i class="fas fa-plus-circle"></i> Tambah</a>
                </div>
                <div class="col-md-12">
                    <div class="card border-0">
                        <div class="card-header bg-console text-dark">
                            <h3 class="card-title">Data Sains Info</h3>
                        </div>
    ...
    <script type="text/javascript">
        $(function () {
          ...
          var table = $('.content-datatable').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ route('admin.get.sains-info') }}",
              columns: [
