...
<div class="content-wrapper">
    @include('console.components.breadcrumb', ['title' => 'Potesial Gudeg Lokal'])
                ...
                <div class="col-md-12">
                    <div class="card border-0">
                        <div class="card-header bg-console text-dark">
                            <h3 class="card-title">Tambah Potesial Gudeg Lokal</h3>
                        </div>

                        <div class="card-body">
                            <form action="{{ route('admin.potential.update', ['id' => $potential->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="title" id="" value="{{ $potential->title }}">
                                                @error('title')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10 pt-2">
                                            <div class="mb-3" id="wrapper-images">
                                                <img src="{{ asset('website/images/upload') . '/' .$potential->images }}" alt="" id="img-content" width="250">
                                            </div>
                                            <div class="">
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10 pt-2">
                                            <div class="form-group">
                                                <textarea id="desc_potential" class="form-control" name="descriptions"> {{ $potential->descriptions }} </textarea>
                                                @error('descriptions')
                                                    <span class="invalid-feedback d-inline" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="row d-none">
                                        ...
                                        <div class="col-10 pt-2">
                                            <div class="form-group icheck-primary d-inline">
                                                {{-- <input type="text" class="form-control" name="title" value="{{ old('title') }}" id=""> --}}
                                                <input type="hidden" class="status_hide" value="{{ $potential->status }}">
                                    ...
                                    <div class="row pt-2">
                                        ...
                                        <div class="col-4">
                                            <div>
                                                <a href="{{ route('admin.potential') }}" class="btn bg-danger text-dark">Kembali</a>
