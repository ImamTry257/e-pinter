...
@section('content')
  ...
  <div class="content-wrapper">
    @include('console.components.breadcrumb', ['title' => 'Kegiatan Pembelajaran'])
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 pb-2">
                    <a href="{{ route('admin.learning.activity.add') }}" class="btn bg-console text-dark"><i class="fas fa-plus-circle"></i> Tambah</a>
                </div>
                <div class="col-md-12">
                    <div class="card border-0">
                        <div class="card-header bg-console text-dark">
                            <h3 class="card-title">Data Kegiatan Pembelajaran</h3>
                        </div>
    ...
    <script type="text/javascript">
        $(function () {
          ...
          var table = $('.la-datatable').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ route('admin.get.learning.activity') }}",
              columns: [
        ...
        function delete_content(id) {
            window.location.href = '{{ url("admin/sains-info/delete") }}'+'/'+id;
