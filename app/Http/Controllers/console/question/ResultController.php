...
use App\Exports\ExportResultQuestionType;
...
class ResultController extends Controller
{
    ...
    public function list($type)
    {
        ...
        return view('console.page.question.result.list', $data);
    }

    public function getStudentQuestionType(Request $request, $type)
    {
        if ($request->ajax()) :
            $this->type = $type;
    ...
    {
        # dd($request->all());
        return Excel::download(new ExportResultQuestionType($type), 'Hasil_Pengerjaan_Siswa_2024_' . date('YmdHis'). '.xlsx');
    }
}
