...
class Controller extends BaseController
{
    ...
    public function selectContentStep($master_id, $step_id, $is_console)
    {
        ...
        $content_activity = ( !$is_console ) ? $this->contentByActivityMaster($title, $content_step_one, $step_id, $master_id) : $this->contentByActivityMasterConsole($title, $content_step_one, $step_id, $master_id);
    ...
    public function contentByActivityMasterConsole($title, $dynamic_content, $step_id, $master_id){
        ...
        if ( $step_id == 1 ) :
            ...
            $content = '<div class="alert-notif"></div>
                        ...
                        <div class="question-a">
                            ...
                            <div class="content-question-a desc-step">
                                <p class="text-justify pt-3 px-3">Jawaban :</p>
                                <p class="text-justify px-3 pb-3 mb-3" style="font-weight: bold;" id="answer-a"></p>
                            </div>
                        </div>
                        <hr/>
                        <div class="question-a">
                            ...
                            <div class="content-question-a desc-step">
                                <p class="text-justify pt-3 px-3">Jawaban :</p>
                                <p class="text-justify px-3 pb-3 mb-3" style="font-weight: bold;" id="answer-b"></p>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="pb-3 row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="date" name="date" class="form-control" id="step-' . $step_id . '" style="border: none; background: transparent; font-weight: bold;" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="pb-3 row">
                                    ...
                                    <div class="col-sm-1">
                                        <input type="time" name="start_time" class="form-control" id="step-' . $step_id . '" style="border: none; background: transparent; font-weight: bold;" readonly>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span>-</span>
                                    </div>
                                    <div class="col-sm-1">
                                        <input type="time" name="end_time" class="form-control" id="step-' . $step_id . '" style="border: none; background: transparent; font-weight: bold;" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="pb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" class="form-control" id="step-' . $step_id . '" style="border: none; background: transparent; font-weight: bold;" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="pb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div id="descriptions" class="form-control" cols="30" rows="10" style="border: none; background: transparent; font-weight: bold;" readonly></div>
                                    </div>
                                </div>
                            </div>
                        </div>';
        ...
        elseif ( $step_id == 6 ) :
            $content = '<div class="alert-notif"></div>
                        ...
                        <div class="question-a">
                            <div class="content-question-a desc-step">
                                <p class="text-justify pt-3 px-3">Jawaban :</p>
                                <p class="text-justify px-3 pb-3 mb-3" style="font-weight: bold;" id="answer"></p>
                            </div>
                        </div>';
        endif ;
